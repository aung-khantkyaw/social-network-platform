    ...
    @forelse ($posts as $post)
        <div class="flex flex-col p-4 bg-gray-100 rounded-lg shadow-xs dark:bg-gray-800">
            ...
            <div class="mt-4">
                ...
                <img src="{{ 'images/thumbnails/' . $post->thumbnail }}" alt="Post Image" class="text-center rounded-lg"
            ...
            <div class="mt-4 flex justify-between">
                <div class="flex items-center">
                    ...
                    <span>
                        @if ($post->likes > 0)
                            <span class="text-xs text-gray-700 dark:text-gray-100 font-bold">{{ $post->likes }}</span>
                ...
                <div>
                    <a href="{{ route('post.show', $post->uuid) }}"class="flex items-center">
                        <button class="hover:bg-gray-800 text-gray-700 dark:text-gray-100 font-medium py-2 rounded mr-2"
                            disabled>
                ...
                <button class="hover:bg-gray-800 text-gray-700 dark:text-gray-100 font-medium py-2 px-4 rounded mr-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
