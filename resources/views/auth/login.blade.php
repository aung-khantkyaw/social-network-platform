...
@section('content')
    <div class="container px-6 mx-auto flex flex-col justify-center items-center">
        <span class="text-white text-2xl font-bold mb-4">Social Network Platform for Online Communities</span>
        <div class="p-4 bg-gray-100 rounded-lg shadow-xl w-1/2 dark:bg-gray-800">
            <h2 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Log in</h2>
            ...
            <form class="flex flex-col" method="POST" action="{{ route('login') }}">
                ...
                <label class="block mt-2 text-sm">
                    <div class="relative text-gray-500 focus-within:text-purple-600">
                        ...
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="w-6 h-6" id="hide">
                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span class="text-gray-400 text-sm text-center mt-4">Don't have an account? <a
